...
export default function ProfilePage() {
  ...
  const notificationSettings: NotificationSetting[] = [
    { label: 'Account notifications', value: notifications, setter: setNotifications },
    { label: 'Product & market updates', value: marketing, setter: setMarketing },
  ];
