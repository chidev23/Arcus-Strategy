...
const legal = [
  ...
  ['Trading Signals Terms','Signal delivery, subscriptions, timing and signal-use restrictions.','trading-signals-terms'],
...
const footerGroups=[
  ...
  {title:'Legal',items:legal.map(x=>[x[0],`/legal/${x[2]}`])}
];
