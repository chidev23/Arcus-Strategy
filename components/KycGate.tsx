    ...
    <div className="mt-7 rounded-2xl border border-[#f0d8da] bg-[#fff7f7] p-5">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-2 text-[12px] leading-6 text-[#68726e]">You must complete KYC verification before subscribing to PropFirm Assisted Trading or ServerLess Algotrading.</p>
          <Link href="/verify" className="mt-4 inline-flex items-center rounded-xl bg-[#087f3f] px-4 py-2.5 text-[11px] font-black text-white">Verify KYC →</Link>
        </div>
      </div>
    </div>
  );
